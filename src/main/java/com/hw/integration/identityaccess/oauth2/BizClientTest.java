...
public class BizClientTest {
    ...
    public void create_resource_client_and_client_which_access_it_then_delete_resource_client() throws InterruptedException {
        ...
        clientAsNonResource.setScopeEnums(scopes);
        ...
        ResponseEntity<DefaultOAuth2AccessToken> tokenResponse = action.getJwtPassword(ACCOUNT_USERNAME_ROOT, ACCOUNT_PASSWORD_ROOT);
        String bearer = tokenResponse.getBody().getValue();
        String url4 = UserAction.proxyUrl + UserAction.SVC_NAME_AUTH + CLIENTS + ACCESS_ROLE_ROOT + "/" + resourceClientId;
        ...
        //get new jwt
        ResponseEntity<DefaultOAuth2AccessToken> jwtPasswordWithClient3 = action.getJwtPasswordWithClient(clientId, clientSecret, ACCOUNT_USERNAME_ADMIN, ACCOUNT_PASSWORD_ADMIN);
