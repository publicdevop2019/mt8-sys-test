...
public class AddressTest {
    ...
    public void shop_read_all_addresses() {
        ...
        String url = "http://localhost:" + randomServerPort + "/v1/api/profiles/" + profileId1 + "/addresses";
    ...
    public void shop_read_address_details() {
        ...
        String profileId1 = action.getProfileId(defaultUserToken);
        String url2 = "http://localhost:" + randomServerPort + "/v1/api/profiles/" + profileId1 + "/addresses";
        ParameterizedTypeReference<List<Address>> responseType = new ParameterizedTypeReference<>() {
        };
        ...
        String url = "http://localhost:" + randomServerPort + "/v1/api/profiles/" + profileId1 + "/addresses/" + id;
